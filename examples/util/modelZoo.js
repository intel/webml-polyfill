const modelZoo = {
  imageClassificationModels: [{
    ...
    inputSize: [227, 227, 3],
    outputSize: 1000,
    modelFile: 'https://webnnmodel.s3-us-west-2.amazonaws.com/image_classification/model/squeezenet_predict.pb',
    labelsFile: 'https://webnnmodel.s3-us-west-2.amazonaws.com/image_classification/model/labels1000.txt',
    preOptions: {
      mean: [104, 117, 123],
      std: [1, 1, 1],
    ...
    inputSize: [224, 224, 3],
    outputSize: 1001,
    modelFile: 'https://webnnmodel.s3-us-west-2.amazonaws.com/image_classification/model/mobilenet_v1_quant_predict.pb',
    labelsFile: 'https://webnnmodel.s3-us-west-2.amazonaws.com/image_classification/model/labels1001.txt',
    preOptions: {
      mean: [127.5, 127.5, 127.5],
      std: [1, 1, 1],
  ...
  semanticSegmentationModels: [{
    ...
    modelSize: '8.4MB',
    modelFile: 'https://webnnmodel.s3-us-west-2.amazonaws.com/semantic_segmentation/model/deeplab_mobilenetv2_224_dilated.bin',
    labelsFile: 'https://webnnmodel.s3-us-west-2.amazonaws.com/semantic_segmentation/model/labels.txt',
    inputSize: [224, 224, 3],
    outputSize: [224, 224, 1],
    preOptions: {
    ...
    modelSize: '8.4MB',
    modelFile: 'https://webnnmodel.s3-us-west-2.amazonaws.com/semantic_segmentation/model/deeplab_mobilenetv2_257_dilated.bin',
    labelsFile: 'https://webnnmodel.s3-us-west-2.amazonaws.com/semantic_segmentation/model/labels.txt',
    inputSize: [257, 257, 3],
    outputSize: [257, 257, 1],
    preOptions: {
    ...
    modelSize: '8.4MB',
    modelFile: 'https://webnnmodel.s3-us-west-2.amazonaws.com/semantic_segmentation/model/deeplab_mobilenetv2_321_dilated.bin',
    labelsFile: 'https://webnnmodel.s3-us-west-2.amazonaws.com/semantic_segmentation/model/labels.txt',
    inputSize: [321, 321, 3],
    outputSize: [321, 321, 1],
    preOptions: {
    ...
    modelSize: '8.4MB',
    modelFile: 'https://webnnmodel.s3-us-west-2.amazonaws.com/semantic_segmentation/model/deeplab_mobilenetv2_513_dilated.bin',
    labelsFile: 'https://webnnmodel.s3-us-west-2.amazonaws.com/semantic_segmentation/model/labels.txt',
    inputSize: [513, 513, 3],
    outputSize: [513, 513, 1],
    preOptions: {
  ...
  speechRecognitionModels: [{
    ...
    inputSize: [1, 440],
    outputSize: [1, 3425],
    modelFile: 'https://webnnmodel.s3-us-west-2.amazonaws.com/speech_recognition/model/wsj_dnn5b.bin',
    arkFile: 'https://webnnmodel.s3-us-west-2.amazonaws.com/speech_recognition/ark/dev93.ark',
    scoreFile: 'https://webnnmodel.s3-us-west-2.amazonaws.com/speech_recognition/ark/dev93_scores.ark',
