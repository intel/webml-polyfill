...
describe('CTS', function() {
  ...
  it('check result for Depthwise conv2d quant8 example/2', async function() {
    // For 'Depthwise conv2d quant8' example: examples
    ...
    let type2 = {type: nn.TENSOR_INT32, dimensions: [4]};
    let type2_length = product(type2.dimensions);
    let type3 = {type: nn.INT32};
    let type4 = {type: nn.TENSOR_QUANT8_ASYMM, dimensions: [1, 2, 1, 4], scale: 1.0, zeroPoint: 127};
