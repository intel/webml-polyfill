...
describe('CTS', function() {
  ...
  it('check result for Depthwise conv2d quant8 large example', async function() {
    // For 'Depthwise conv2d quant8 large' example: examples
    ...
    model.setOperandValue(op2, new Uint8Array([2, 4, 2, 0, 2, 2, 2, 0]));
