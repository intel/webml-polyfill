...
describe('CTS', function() {
  ...
  it('check result for Conv quant8 overflow example', async function() {
    // For 'Conv quant8 overflow' example: examples
    ...
    model.setOperandValue(op2, new Uint8Array([10, 40, 70, 20, 50, 80, 30, 60, 90]));
    model.setOperandValue(op3, new Int32Array([0, 0, 0]));
