...
describe('CTS', function() {
  ...
  it('check result for Logistic quant8 example/2', async function() {
    ...
    model.addOperation(nn.LOGISTIC, [input], [output]);
    ...
    let output_output = new Uint8Array(type1_length);
