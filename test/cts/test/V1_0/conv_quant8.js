...
describe('CTS', function() {
  ...
  it('check result for Conv quant8 example', async function() {
    // For 'Conv quant8' example: examples
    ...
    let type4 = {type: nn.TENSOR_QUANT8_ASYMM, dimensions: [1, 2, 2, 1], scale: 1.0, zeroPoint: 0};
