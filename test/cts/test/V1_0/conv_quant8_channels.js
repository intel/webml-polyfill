...
describe('CTS', function() {
  ...
  it('check result for Conv quant8 channels example', async function() {
    // For 'Conv quant8 channels' example: examples
    ...
    model.setOperandValue(op2, new Uint8Array([1, 2, 3, 4, 5, 6, 7, 8, 9]));
