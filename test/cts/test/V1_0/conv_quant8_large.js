...
describe('CTS', function() {
  ...
  it('check result for Conv quant8 large example', async function() {
    // For 'Conv quant8 large' example: examples
    ...
    model.setOperandValue(op2, new Uint8Array([1, 4, 7, 2, 5, 8, 3, 6, 9]));
