...
describe('CTS', function() {
  ...
  it('check result for Resize bilinear 2 relaxed example', async function() {
    // For 'Resize bilinear 2 relaxed' example: examples
    ...
    model.addOperation(nn.RESIZE_BILINEAR, [op1, width, height], [op2]);
