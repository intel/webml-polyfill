...
describe('CTS', function() {
  ...
  it('check result for Fully connected float large weights as inputs relaxed example', async function() {
    // For 'Fully connected float large weights as inputs relaxed' example: examples
