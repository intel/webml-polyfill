...
describe('CTS', function() {
  ...
  it('check result for Reshape weights as inputs relaxed example', async function() {
    // For 'Reshape weights as inputs relaxed' example: examples
    ...
    model.setOperandValue(op2, new Int32Array(op2_value));
