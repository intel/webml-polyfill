...
describe('CTS', function() {
  ...
  it('check result for Conv float channels weights as inputs relaxed example', async function() {
    // For 'Conv float channels weights as inputs relaxed' example: examples
