...
describe('CTS', function() {
  ...
  it('check result for Conv 3 h3 w2 valid relaxed example-1', async function() {
    // For 'Conv 3 h3 w2 valid relaxed' example: examples
  ...
  it('check result for Conv 3 h3 w2 valid relaxed example-2', async function() {
    // For 'Conv 3 h3 w2 valid relaxed' example: examples_2
    let model = await nn.createModel(options);
    let operandIndex = 0;
