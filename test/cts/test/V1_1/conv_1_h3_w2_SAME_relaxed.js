...
describe('CTS', function() {
  ...
  it('check result for Conv 1 h3 w2 same relaxed example-1', async function() {
    // For 'Conv 1 h3 w2 same relaxed' example: examples
  ...
  it('check result for Conv 1 h3 w2 same relaxed example-2', async function() {
    // For 'Conv 1 h3 w2 same relaxed' example: examples_2
    let model = await nn.createModel(options);
    let operandIndex = 0;
