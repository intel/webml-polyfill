...
describe('CTS', function() {
  ...
  it('check result for Depthwise conv2d float large 2 weights as inputs relaxed example', async function() {
    // For 'Depthwise conv2d float large 2 weights as inputs relaxed' example: examples
    ...
    let op3_value = [6000, 7000, 8000, 9000];
