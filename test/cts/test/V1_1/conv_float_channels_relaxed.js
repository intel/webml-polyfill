...
describe('CTS', function() {
  ...
  it('check result for Conv float channels relaxed example', async function() {
    // For 'Conv float channels relaxed' example: examples
    ...
    model.setOperandValue(op2, new Float32Array([1.0, 1.0, 1.0, 2.0, 2.0, 2.0, 3.0, 3.0, 3.0]));
