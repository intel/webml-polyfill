...
describe('CTS', function() {
  ...
  it('check result for Depthwise conv relaxed example-1', async function() {
    // For 'Depthwise conv relaxed' example: examples
  ...
  it('check result for Depthwise conv relaxed example-2', async function() {
    // For 'Depthwise conv relaxed' example: examples_2
    let model = await nn.createModel(options);
    let operandIndex = 0;
