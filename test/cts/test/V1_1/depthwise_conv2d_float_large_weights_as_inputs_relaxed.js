...
describe('CTS', function() {
  ...
  it('check result for Depthwise conv2d float large weights as inputs relaxed example', async function() {
    // For 'Depthwise conv2d float large weights as inputs relaxed' example: examples
