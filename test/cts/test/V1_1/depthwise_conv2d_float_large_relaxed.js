...
describe('CTS', function() {
  ...
  it('check result for Depthwise conv2d float large relaxed example', async function() {
    // For 'Depthwise conv2d float large relaxed' example: examples
    ...
    model.setOperandValue(op2, new Float32Array([0.25, 0, 0.25, 1, 0.25, 0, 0.25, 1]));
    model.setOperandValue(op3, new Float32Array([100, 200]));
