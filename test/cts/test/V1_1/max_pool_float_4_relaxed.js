...
describe('CTS', function() {
  ...
  it('check result for Max pool float 4 relaxed example', async function() {
    // For 'Max pool float 4 relaxed' example: examples
    ...
    model.addOperation(nn.MAX_POOL_2D, [op1, pad_same, cons2, cons2, cons2, cons2, act_none], [op3]);
