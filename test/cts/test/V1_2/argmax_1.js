...
describe('CTS', function() {
  ...
  it('check result for Argmax example/1-1', async function() {
  ...
  it('check result for Argmax example/1-2', async function() {
  ...
  it('check result for Argmax example/1-3', async function() {
  ...
  it('check result for Argmax example/1-5', async function() {
