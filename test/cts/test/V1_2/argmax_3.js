...
describe('CTS', function() {
  ...
  it('check result for Argmax example/3-2', async function() {
  ...
  it('check result for Argmax example/3-3', async function() {
  ...
  it('check result for Argmax example/3-5', async function() {
