describe('CTS', function() {
  ...
  it('check result for Conv 1 h3 w2 same relu6 example-1', async function() {
    ...
    let op3_expect = [1.852844476699829, 0, 0, 1.431152105331421, 0, 0, 0.6550236940383911, 0, 1.7200324535369873, 1.5581609010696411, 0.6675475239753723, 2.236632823944092, 0.06615253537893295, 0.29025331139564514, 0.7702214121818542, 0, 0, 0, 0, 0.9499664306640625, 0, 0, 2.341318130493164, 0, 0, 0, 0.8151464462280273, 1.0311371088027954, 0, 0, 0, 1.4202649593353271, 0, 0.6731129288673401, 3.061389923095703, 0, 0, 0, 0, 0, 0.4327876567840576, 0, 1.12943696975708, 0, 0, 1.4009473323822021, 0.7083194851875305, 0, 2.19561767578125, 0, 0, 1.2612414360046387, 1.4654470682144165, 0, 2.0449378490448, 1.2374132871627808, 0, 0, 0, 1.3644005060195923, 0.9857543706893921, 0, 0, 1.2432724237442017];
    ...
    model.setOperandValue(b7, new Int32Array([3]));
  ...
  it('check result for Conv 1 h3 w2 same relu6 example-2', async function() {
    let model = await nn.createModel(options);
    let operandIndex = 0;
    ...
    let op3_expect = [0, 0, 0.4438609182834625, 0.10211732238531113, 0, 1.47488534450531, 0.17347386479377747, 0, 1.2873539924621582, 1.9131495952606201, 2.517343282699585, 0.3758420944213867, 0.6375616788864136, 2.6529979705810547, 2.7295899391174316, 0, 1.1738859415054321, 0, 2.9141669273376465, 0, 0.04970327764749527, 0, 0, 0, 0, 0, 0, 0, 1.292771816253662, 1.329630970954895, 0.11751936376094818, 1.2237162590026855, 0.06657037138938904, 1.094380497932434, 0, 2.5259385108947754, 0, 0.5154775381088257, 0, 0, 0.13521121442317963, 0.7864166498184204, 0, 0, 0, 0.2816144824028015, 2.36311411857605, 0.8918237686157227, 1.9387190341949463, 0, 3.4521725177764893, 2.2821848392486572, 1.182815670967102, 0, 3.054673910140991, 0.1662285327911377, 0.43455466628074646, 0, 0, 0, 2.6677565574645996, 0.5426009893417358, 1.7610653638839722, 0];
