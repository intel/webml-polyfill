describe('CTS', function() {
  ...
  it('check result for Conv 1 h3 w2 valid relu1 example-1', async function() {
    ...
    let op3_expect = [1, 1, 0.6675475239753723, 1, 0.06615253537893295, 0.29025331139564514, 0.7702214121818542, -1.0, -0.8505960702896118, -0.48422494530677795, 0.9499664306640625, -0.5772628784179688, -0.871949315071106, 1, -0.1359645128250122, -0.9857118129730225, 0.8151464462280273, 1, -1.0, -0.515534520149231, -0.3736388683319092, -1.0, 0.6731129288673401, 1, -0.38857704401016235, -1.0, -0.31566688418388367, -1.0, 0.4327876567840576, -1.0, 1, -0.1758061945438385, -0.8464152812957764, 1, 0.7083194851875305, 1, -1.0, -0.7053839564323425, 1, 1, -1.0, 1];
  ...
  it('check result for Conv 1 h3 w2 valid relu1 example-2', async function() {
    let model = await nn.createModel(options);
    let operandIndex = 0;
    ...
    let op3_expect = [1, 1, 1, 0.3758420944213867, 0.6375616788864136, 1, 1, 1, -1.0, 1, -1.0, 0.04970327764749527, -0.1271056979894638, -0.1444731503725052, -0.39328449964523315, -1.0, -0.23917758464813232, -0.24650941789150238, 1, 1, 0.11751936376094818, 0.06657037138938904, 1, -1.0, 1, -0.9692087769508362, 0.5154775381088257, -1.0, 0.13521121442317963, 0.7864166498184204, -1.0, -0.7391021251678467, -1.0, 0.2816144824028015, 1, 1, -0.15049007534980774, 1, 1, 1, -1.0, 1];
