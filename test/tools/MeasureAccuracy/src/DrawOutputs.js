class Renderer {
  constructor(canvas) {
    ...
    this._clippedSize = [513, 513];//[224, 224];
  ...
  async drawOutputs(newSegMap) {
    ...
    this.gl.canvas.width = this.ow;// 500;//this._clippedSize[0] * this._zoom;
    this.gl.canvas.height = this.oh;//375;//this._clippedSize[1] * this._zoom;
    ...
    if (this._effect === 'label') {
      ...
      // this.gl.canvas.height = 375;
      //var dataURL = this.gl.canvas.toDataURL('image/png');
      //console.log("dataURL:", dataURL);
      //document.getElementById('abc').href = dataURL;
    }
