class Utils {
  ...
  prepareInput(imgSrc, renderer) {
    ...
    renderer.ow = imWidth;
    renderer.oh = imHeight;
    let scaledWidth = 513;//Math.floor(imWidth / resizeRatio);
    let scaledHeight = 513;//Math.floor(imHeight / resizeRatio);
