...
async function splitContext(context) {
  ...
  case 1: {
    ...
    // let padding1 = (await getOperands(context[1][2]))[0];
    // let padding2 = (await getOperands(context[1][3]))[0];
    // let padding3 = (await getOperands(context[1][4]))[0];
    let stride = (await getOperands(context[1][5]))[0];
    // let stride1 = (await getOperands(context[1][6]))[0];
    let filter = (await getOperands(context[1][7]))[0];
    // let filter1 = (await getOperands(context[1][8]))[0];
  ...
  case 3: {
    ...
    // let pad1 = (await getOperands(context[1][4]))[0];
    // let pad2 = (await getOperands(context[1][5]))[0];
    // let pad3 = (await getOperands(context[1][6]))[0];
    let stride = (await getOperands(context[1][7]))[0];
    // let stride1 = (await getOperands(context[1][8]))[0];
